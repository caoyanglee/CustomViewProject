...
class SimpleButton : TextView {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyle: Int) : super(context, attrs, defStyle) {
        val attr = context.obtainStyledAttributes(attrs, R.styleable.SimpleButton, defStyle, 0)
        //background
        val backgroundColor = attr.getColor(R.styleable.SimpleButton_wm_backgroundColor, Color.TRANSPARENT)
        val backgroundPressColor = attr.getColor(R.styleable.SimpleButton_wm_backgroundPressColor, Color.TRANSPARENT)
        val backgroundUnEnableColor = attr.getColor(R.styleable.SimpleButton_wm_backgroundUnEnableColor, backgroundColor)
        //stroke
        val strokeWidth = attr.getDimension(R.styleable.SimpleButton_wm_strokeWidth, 0f)
        val strokeColor = attr.getColor(R.styleable.SimpleButton_wm_strokeColor, Color.TRANSPARENT)
        val strokePressColor = attr.getColor(R.styleable.SimpleButton_wm_strokePressColor, Color.TRANSPARENT)
        val strokeUnEnableColor =  attr.getColor(R.styleable.SimpleButton_wm_strokePressColor, strokeColor)
        //corner
        val cornerRadius = attr.getDimension(R.styleable.SimpleButton_wm_cornerRadius, -1f)
        val cornerRadius_TL = attr.getDimension(R.styleable.SimpleButton_wm_cornerRadius_TL, 0f)
        val cornerRadius_TR = attr.getDimension(R.styleable.SimpleButton_wm_cornerRadius_TR, 0f)
        val cornerRadius_BL = attr.getDimension(R.styleable.SimpleButton_wm_cornerRadius_BL, 0f)
        val cornerRadius_BR = attr.getDimension(R.styleable.SimpleButton_wm_cornerRadius_BR, 0f)
        //textPressColor
        val textColor = attr.getColor(R.styleable.SimpleButton_wm_textColor, Color.TRANSPARENT)
        val textPressColor = attr.getColor(R.styleable.SimpleButton_wm_textPressColor, Color.TRANSPARENT)
        val textUnEnableColor = attr.getColor(R.styleable.SimpleButton_wm_textUnEnableColor, Color.TRANSPARENT)
